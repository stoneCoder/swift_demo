...
//  SwiftDemo
//
//  Created by sinosun on 2020/11/25.
...
//        self.btn.backgroundColor = UIColor.red;
        ...
        listVC.view.frame = CGRect.init(x: 10, y: visiableY, width: SCREEN_WIDTH - 20, height: SCREEN_HEIGHT - visiableY - 29 - NAVBAR_HEIGHT)
...
//        }
    ...
    @objc func musicPlayClick(sender:UIButton){
        ...
        JKAudioStreamPlayer(audioFile: URL.init(string: "https://m801.music.126.net/20201102164844/a84ae0b002e5252944c28b16fae7040f/jdyyaac/0f09/5659/0658/8cb5fe2439a36781a092122f757c76b6.m4a")!)
        return
...
//        self.present(webVC, animated: true, completion: nil)
        ...
        webVC.loadLocalLoadUrlInViewWith(url: Bundle.main.path(forResource: "test.html", ofType: nil)!)
